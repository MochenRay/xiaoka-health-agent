...
| Phase 2C 截图先行录入 | [data-schema.md](data-schema.md) 与 `fixtures/synthetic/phase2c/` | 已完成 synthetic mapping fixture 验证；真实 OCR runtime smoke 未完成 |
...
- 可说：小卡是本地文件驱动的健康 Agent 包，核心 workflow、OpenClaw 五条
  cron、周报/月报、截图先行 mapping fixture、C8 静态合同均已建立。
- 不可说：真实 OCR、Apple Health 历史同步、C8 runtime 报告、医学趋势分析
